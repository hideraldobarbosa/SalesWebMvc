...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Maria Xicória", "mariaxicoria@gmail.com", new DateTime(1988, 4, 30), 1250.00, d1);
            Seller s2 = new Seller(2, "Jose das Couve", "mariaxicoria@gmail.com", new DateTime(1985, 3, 20), 1080.00, d2);
            Seller s3 = new Seller(3, "Ana Clara", "anaclara@gmail.com", new DateTime(2001, 6, 25), 1110.00, d1);
            Seller s4 = new Seller(4, "Elessandra", "elessandra@gmail.com", new DateTime(1974, 7, 12), 1250.00, d4);
            Seller s5 = new Seller(5, "Mel", "mel@gmail.com", new DateTime(2012, 6, 22), 50.00, d3);
            Seller s6 = new Seller(6, "Kirk", "kirk@gmail.com", new DateTime(1955, 4, 22), 1307.00, d2);
